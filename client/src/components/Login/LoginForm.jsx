...
function LoginForm() {
  ...
  return (
    <form onSubmit={onSubmit}
      ...
      className="bg-primary-500/60 p-6 rounded w-96" // Aplica clases de Tailwind CSS para el estilo del formulario
    >
      <h1 className="text-2xl text-center border-b border-slate-400 mb-5 pb-4 font-bold text-white">Sistemas de Audiencias Municipal</h1>
